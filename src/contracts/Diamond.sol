...
contract Diamond {
    ...
    constructor(
        ...
        LibERC20Storage.ERC20Storage storage token = LibERC20Storage.erc20Storage();
        ...
        token._balances[tokenReceiver] = tokenSupply;
        // emit Transfer(address(0), tokenReceiver, tokenSupply);
    }
