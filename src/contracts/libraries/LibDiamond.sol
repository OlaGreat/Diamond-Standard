...
library LibDiamond {
    ...
    function diamondStorage() internal pure returns (DiamondStorage storage diamondstorage) {
    ...
    function setContractOwner (address _newOwner) internal {
        DiamondStorage storage _diamondStorage = diamondStorage();
        address previousOwner = _diamondStorage.contractOwner;
        _diamondStorage.contractOwner = _newOwner;
